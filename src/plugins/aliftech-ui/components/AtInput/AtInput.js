import { h, ref, defineComponent, withDirectives, resolveDirective, defineAsyncComponent } from 'vue';
...
export default defineComponent({
  ...
  render() {
    const inputEl = h('input', {
      ...
      onInput: event =>
        this.$emit('update:modelValue', this.mask ? event.target.value.replaceAll(' ', '') : event.target.value),
    });
    return h('div', [
      ...
      h(
        ...
        [
          ...
          h('div', { class: 'relative w-full' }, [
            this.mask ? withDirectives(inputEl, [[this.maskDirective, this.mask]]) : inputEl,
            this.error
              ? h(
                  'div',
                  {
