...
export default defineComponent({
  ...
  render() {
    ...
    if ('userDropdownItem' in this.$slots) slots['userDropdownItem'] = () => this.$slots.userDropdownItem();
    ...
    return h('div', { class: ['h-screen flex overflow-hidden z-50'] }, [
      ...
      h('div', { class: ['flex flex-col w-0 flex-1 overflow-hidden'] }, [
        this.isMobileOrTablet
          ? h(
              ...
              [
                h(
                  ...
                  [h('span', { class: ['sr-only'] }, 'Open sidebar'), h('fe-list-icon')]
                ),
                this.noUserSection
                  ? null
                  : h('div', { class: 'flex items-center justify-end w-full pr-4' }, [
                      h(
                        SidebarUserDropdown,
                        {
                          user: this.user,
                        ...
                        {
                          userDropdownItems: () =>
                            'userDropdownItem' in this.$slots ? this.$slots.userDropdownItem?.() : null,
                        }
                      ),
                    ]),
              ]
          ...
          : null,
        h('div', { class: ['p-6 overflow-auto h-screen'] }, [this.$slots.default?.()]),
      ]),
    ]);
  },
});
